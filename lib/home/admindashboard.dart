      ...
      body: SingleChildScrollView(
        child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
          ...
          builder: (context, snapshot) {
            ...
            var currentDocument = documents.where((element) => element.get('date') == '2022/03/12').toList()
            [0]; // get single doc of current date

            AttendencReportModel attendencModel = AttendencReportModel.fromJson(currentDocument.data());

            print(attendencModel.checkin);

            var checkinTime  = attendencModel.checkin.toString();
            var checkinHours  = checkinTime.split(':');

            print(checkinTime);
            print(checkinHours);

          var checkInMinutes =  checkinHours[1].split(' ');
            print(checkInMinutes);



            var checkoutTime  = currentDocument.get('checkout').toString();
            var checkoutHours  = checkoutTime.split(':');

            print(checkoutTime);
            print(checkoutHours);

            var checkoutMinutes =  checkoutHours[1].split(' ');
          ...
          var convertedCheckinTime =  DateFormat('hh:mm a').parse(checkinTime);
            var convertedCheckoutTime =  DateFormat('hh:mm a').parse(checkoutTime);

          print(convertedCheckinTime);
            print(convertedCheckoutTime);

            //calculating difference
         var difference1 =   convertedCheckoutTime.difference(convertedCheckinTime);

          var convertedDifference = difference1.toString().split(':');

          var difference = convertedDifference[0] + ':' + convertedDifference[1];

            print('date : ${convertedDifference[0] + ':' + convertedDifference[1] }');


            print(jsonEncode(currentDocument.data()));
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Center(child: Text(checkinHours[0],style: TextStyle(color: kblue,fontSize: 18),)),
                                      ),
                                      SizedBox(width: 15),
                                      Container(
                                        height: Get.height*0.05,
                                        width: Get.width*0.09,
                                        color: Colors.grey.shade400,
                                        child: Center(child: Text(checkInMinutes[0],style: TextStyle(color: kblue,fontSize: 18),)),
                                      ),
                                      ...
                                      Container(
                                        ...
                                        child: Center(
                                          child: Row(
                                            mainAxisSize: MainAxisSize.min,
                                            children: [
                                              Text(checkInMinutes[1],style: TextStyle(color: kblue,fontSize: 18),),
                                              SizedBox(width: 10,),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    width: Get.width*0.09,
                                    color: Colors.grey.shade400,
                                    child: Center(child: Text(checkoutHours[0],style: TextStyle(color: kblue,fontSize: 18),)),
                                  ),
                                  SizedBox(width: 15),
                                  Container(
                                    height: Get.height*0.05,
                                    width: Get.width*0.09,
                                    color: Colors.grey.shade400,
                                    child: Center(child: Text(checkoutMinutes[0],style: TextStyle(color: kblue,fontSize: 18),)),
                                  ),
                                  ...
                                  Container(
                                    ...
                                    child: Center(
                                      child: Row(
                                        mainAxisSize: MainAxisSize.min,
                                        children: [
                                          Text(checkoutMinutes[1],style: TextStyle(color: kblue,fontSize: 18),),
                                        ],
                                      ),
                                    ),
                                  ),

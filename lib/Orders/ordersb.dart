...
class _Addorder23State extends State<Addorder23> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: GetX<MyEmpController>(
        init: Get.put(MyEmpController()),
        builder: (empcontroller) {
          return empcontroller.myepmlist.value.uid == null ?
                kprogressbar
              :Scaffold(
            body: Container(
                              ...
                              onTap: () {
                                firestore.add(
                                  ...
                                  "quantity" : quantity.text,
                                      "cid" : empcontroller.myepmlist.value.cid,
                                      "bid" : empcontroller.myepmlist.value.bid,
                                      "did" : empcontroller.myepmlist.value.did,
                                      "uid" : empcontroller.myepmlist.value.uid,

...
class Addproduct26 extends StatefulWidget {
  const Addproduct26({Key? key}) : super(key: key);

  @override
  _Addproduct26State createState() => _Addproduct26State();
}

class _Addproduct26State extends State<Addproduct26> {
  @override

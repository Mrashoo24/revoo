...
class LeaveHistory extends StatefulWidget {  final DocumentSnapshot<Map<String, dynamic>> userDoc ;
const LeaveHistory({Key? key, required this.userDoc}) : super(key: key);
...
class _LeaveHistoryState extends State<LeaveHistory> {
          ...
          children: [
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                  stream:FirebaseFirestore.instance.collection('Leaves').where('uid',isEqualTo: widget.userDoc.get('uid')).snapshots(),
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context,index){
                        ...
                        return
                          ...
                          buildPendingCard(name: allLeaveList.name.toString()
  ...
  Container buildPendingCard({required String name,required String department, required String date,required LeaveDisplay  lsitofleaves,required String textinput}) {

    return Container(
      margin: EdgeInsets.symmetric(vertical: 20),
      decoration: BoxDecoration(
          color: bgGrey,
          boxShadow: [BoxShadow(color: kyellow,offset: Offset(0, 1),blurRadius: 10),]
      ),

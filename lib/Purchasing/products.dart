...
class _HRMSadmincustState extends State<Products> {
  String initialValue = '';
                      ...
                      Row(
                        ...
                        children: [
                          Align(
                            ...
                            child: Text('Products',style: TextStyle(color:kblue,fontSize: 35),
                            ),
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Padding(
                                      padding:   EdgeInsets.only(left: 145.0,bottom: 10),
                                      child: Icon(Icons.more_vert,color: Colors.white),
                                    ),

...
///////////////////////////////////////////////////////////////////////////////////////////////
class Addnewvendorb extends StatelessWidget {
  String idval;
  Addnewvendorb({required this.idval});


  @override
  Widget build(BuildContext context) {
    return Addnewvendorbb();
  }
}

///////////////////////////////////////////////////////////////////////////////////////////////

class Addnewvendorbb extends StatefulWidget {
  const Addnewvendorbb({Key? key}) : super(key: key);
  @override
  _AddnewvendorState createState() => _AddnewvendorState();
}

class _AddnewvendorState extends State<Addnewvendorbb> {
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: (){
                        FirebaseFirestore.instance.collection('vendors').doc().update(
                            {

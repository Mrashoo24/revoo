...
class Logouthmpg extends StatefulWidget {
  const Logouthmpg({Key? key}) : super(key: key);

  @override
  _HomePageMainState createState() => _HomePageMainState();
}

class _HomePageMainState extends State<Logouthmpg> {
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              Align(
                                ...
                                child: Container(
                                    child: Text('Asif Nazir',style: TextStyle(fontSize: 20,color: kblue),
                  ...
                  buildNavCard('asset/checkgrp.png','Create RFQ'),
                  SizedBox(height: 5,),
                  Divider(height:0,thickness: 2,endIndent: 50,indent: 25,),
                  buildNavCard('asset/checkpad.png','RFQ Status'),
                  SizedBox(height: 5,),
                  Divider(height:0,thickness: 2,endIndent: 50,indent: 25,),
                  buildNavCard(' ','Vendors'),
                  SizedBox(height: 5,),
                  Divider(height:0,thickness: 2,endIndent: 50,indent: 25,),
                  buildNavCard(' ','Purchase History'),
                  SizedBox(height: 5,),
                  Divider(height:0,thickness: 2,endIndent: 50,indent: 25,),
                  buildNavCard(' ','Products'),
                  SizedBox(height: 5,),
                  Divider(height:0,thickness: 2,endIndent: 50,indent: 25,),
                  buildNavCard(' ','Product Categories'),
                  SizedBox(height: 5,),
                  Divider(height:0,thickness: 2,endIndent: 50,indent: 25,),
                  buildNavCard(' ','RFQ Recods'),
                  SizedBox(height: 5,),
                  Divider(height:0,thickness: 2,endIndent: 50,indent: 25,),
                  buildNavCard(' ','Reports'),
                  SizedBox(height: 5,),
                  Divider(height:0,thickness: 2,endIndent: 50,indent: 25,),
                  buildNavCard(' ','Calendar'),
                  SizedBox(height: 5,),
                  Divider(height:0,thickness: 2,endIndent: 50,indent: 25,),
                  buildNavCard(' ','Bills & Invoice'),
                  SizedBox(height: 5,),
                  Divider(height:0,thickness: 2,endIndent: 50,indent: 25,),
                  buildNavCard(' ','Logout'),
                ],

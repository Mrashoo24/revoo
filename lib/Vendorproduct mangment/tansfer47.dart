...
class Transfer47 extends StatefulWidget {
  const Transfer47({Key? key}) : super(key: key);

  @override
  _Transfer47State createState() => _Transfer47State();
}

class _Transfer47State extends State<Transfer47> {
  @override
